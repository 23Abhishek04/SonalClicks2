      ...
      <section className="px-6 pb-16 pt-32 sm:px-10 md:px-12 md:pt-40 lg:px-16 lg:pb-24">
        <div className="mx-auto max-w-[1600px]">
          ...
          <div className="mt-14 md:mt-20">
            ...
            >
              Pre-wedding photography that captures your connection,
              your chemistry, and the little moments that make your story yours.
            </m.p>
        ...
        >
          ...
          <div className="md:col-span-8">
            ...
            <h2 className="mt-5 max-w-4xl font-serif text-4xl leading-[1] tracking-[-0.04em] sm:text-5xl md:text-6xl lg:text-7xl">
              We capture
              <br />
              <span className="italic">what brings you closer.</span>
            </h2>
          </div>

          <div className="md:col-span-4 md:pt-10">
            <p className="text-sm leading-7 text-[#6b6459]">
              A pre-wedding session should feel less like a photoshoot
              and more like time spent together. We focus on natural
              expressions, genuine connection and photographs that feel like you.
            </p>
          </div>
